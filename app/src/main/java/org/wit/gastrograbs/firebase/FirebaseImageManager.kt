...
//    }
    ...
    fun updateGrabImage(userid: String, grabid: String, grab: GrabModel, imageUri : Uri?, imageView: ImageView, updating : Boolean) {
    ...
    fun updateDefaultImage(userid: String, grabid: String, grab: GrabModel, resource: Int, imageView: ImageView) {
        Picasso.get().load(resource)
            ...
            .into(object : Target {
                override fun onBitmapLoaded(bitmap: Bitmap?,
                    ...
                    Timber.i("DX onBitmapLoaded $bitmap")
                    uploadImageToFirebase(userid, grabid, grab, bitmap!!,false)
                    imageView.setImageBitmap(bitmap)
                }
